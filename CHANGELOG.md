...
Spans the PR #29 megamerge (20 sub-projects) + PRs #30–#39 + the maintenance follow-up (eight feature follow-on items shipped 2026-05-29 / 2026-05-30, plus the post-#39 maintenance pass). Test suite is **678 tests; 677 pass, 1 skip** (only the CUDA-gated 2:4 semi-structured sparsity path skips on CPU runners — the previously-skipped `onnxscript` dynamo paths now resolve under current torch / onnxscript).
